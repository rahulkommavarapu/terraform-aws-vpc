...
#Creating the Peering fot public subnet Route Table
...
# Creating the Peering for Private Subnet Route Table
 ...
 # Creating the Peering for database subnet Route Table
 ...
 # Creating the peering for default VPC Route Table
